...
let nowIKnow2: number = iDontKnow as number; //utiliza el casteo explicito para asignarle a nowIKnow un string;
let nowIKnow3: number[] = iDontKnow as [number]; //utiliza el casteo explicito para asignarle a nowIKnow un string;
let nowIKnow4: {} = iDontKnow; //utiliza el casteo explicito para asignarle a nowIKnow un string;
